...
static void initialize_set_pwm_output_on_subscriber(MotorNumber motor_number, const char *topic_name, rcl_node_t *stm32_node, rclc_executor_t *executor)
{
...
{
    initialize_set_pwm_output_on_subscriber(MOTOR0, "motor_0/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR1, "motor_1/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR2, "motor_2/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR3, "motor_3/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR4, "motor_4/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR5, "motor_5/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR6, "motor_6/set_pwm_output_on", stm32_node, executor);
    initialize_set_pwm_output_on_subscriber(MOTOR7, "motor_7/set_pwm_output_on", stm32_node, executor);
}
