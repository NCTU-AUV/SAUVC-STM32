...
static void initialize_is_pwm_output_on_publisher(MotorNumber motor_number, const char *topic_name, rcl_node_t *motor_pwm_controller_node)
{
...
void initialize_is_pwm_output_on_publisher_for_all_motors(rcl_node_t *motor_pwm_controller_node)
{
    initialize_is_pwm_output_on_publisher(MOTOR0, "motor_0/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR1, "motor_1/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR2, "motor_2/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR3, "motor_3/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR4, "motor_4/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR5, "motor_5/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR6, "motor_6/is_pwm_output_on", motor_pwm_controller_node);
    initialize_is_pwm_output_on_publisher(MOTOR7, "motor_7/is_pwm_output_on", motor_pwm_controller_node);
}
